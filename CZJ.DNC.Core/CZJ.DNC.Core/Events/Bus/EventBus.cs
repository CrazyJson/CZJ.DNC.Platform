...
using CZJ.Events.Bus.Factories.Internals;
using CZJ.Events.Bus.Handlers;
using CZJ.Events.Bus.Handlers.Internals;
...
namespace CZJ.Events.Bus
{
    ...
    public class EventBus : IEventBus
    {
        ...
        /// </summary>
        public EventBus(ILogger<EventBus> logger, IIocManager iocManager)
        {
            //InitEventHandler(iocManager);
        ...
        public void Trigger(Type eventType, object eventSource, IEventData eventData)
        {
                ...
                typeof(IEventDataWithInheritableGenericArgument).IsAssignableFrom(eventType))
            {
                ...
                if (baseArg != null)
                {
                    ...
                    baseEventData.ReportedTime = eventData.ReportedTime;
