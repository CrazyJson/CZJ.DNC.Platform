...
namespace CZJ.DNC.Net
{
    ...
    public class MimeHelper
    {
        ...
        {
            {".323", "00"},{".asx", "04"},{".acx", "09"},{".ai", "09"},{".aif", "05"},{".aiff", "05"},{".axs", "09"},
            {".aifc", "05"},{".asr", "04"},{".avi", "04"},{".asf", "04"},{".au", "05"},{".application", "09"},{".bin", "07"},
            {".bas", "00"},{".bcpio", "09"},{".bmp", "03"},{".cdf", "09"},{".cat", "09"},{".crt", "09"},{".c", "00"},
            {".css", "06"},{".cer", "09"},{".crl", "09"},{".cmx", "03"},{".csh", "09"},{".cod", "03"},{".cpio", "09"},{".clp", "09"},
            {".crd", "09"},{".deploy", "07"},{".dll", "09"},{".dot", "01"},{".doc", "01"},{".docx", "01"},{".dvi", "09"},{".dir", "09"},
            {".dxr", "09"},{".der", "09"},{".dib", "03"},{".dcr", "09"},{".disco", "00"},{".exe", "07"},{".etx", "00"},{".evy", "09"},
            {".eml", "10"},{".eps", "09"},{".flr", "09"},{".fif", "09"},{".gtar", "09"},{".gif", "03"},{".gz", "08"},{".hta", "09"},{".htc", "00"},
            {".htt", "00"},{".h", "00"},{".hdf", "09"},{".hlp", "09"},{".html", "06"},{".htm", "06"},{".hqx", "09"},{".isp", "09"},
            {".iii", "09"},{".ief", "03"},{".ivf", "04"},{".ins", "09"},{".ico", "03"},{".jpg", "03"},{".jfif", "03"},{".jpe", "03"},
            {".jpeg", "03"},{".js", "06"},{".lsx", "04"},{".latex", "09"},{".lsf", "04"},{".manifest", "09"},{".mhtml", "10"},{".mny", "09"},
            {".mht", "10"},{".mid", "05"},{".mpv2", "04"},{".man", "09"},{".mvb", "09"},{".mpeg", "04"},{".m3u", "05"},{".mdb", "09"},{".mpp", "01"},
            {".m1v", "04"},{".mpa", "04"},{".me", "09"},{".m13", "09"},{".movie", "04"},{".m14", "09"},{".mpe", "04"},{".mp2", "04"},
            {".mov", "04"},{".mp3", "05"},{".mpg", "04"},{".ms", "09"},{".nc", "09"},{".nws", "10"},{".oda", "09"},{".ods", "09"},
            {".pmc", "09"},{".p7r", "09"},{".p7b", "09"},{".p7s", "09"},{".pmw", "09"},{".ps", "09"},{".p7c", "09"},{".pbm", "03"},
            {".ppm", "03"},{".pub", "09"},{".pnm", "03"},{".png", "03"},{".pml", "09"},{".p10", "09"},{".pfx", "09"},{".p12", "09"},
            {".pdf", "02"},{".pps", "01"},{".p7m", "09"},{".pko", "09"},{".ppt", "01"},{".pptx", "01"},{".pmr", "09"},{".pma", "09"},
            {".pot", "01"},{".prf", "09"},{".pgm", "03"},{".qt", "04"},{".ra", "05"},{".rgb", "03"},{".ram", "05"},{".rmi", "05"},
            {".ras", "03"},{".roff", "09"},{".rtf", "00"},{".rtx", "00"},{".sv4crc", "09"},{".spc", "09"},{".setreg", "09"},{".snd", "05"},
            {".stl", "09"},{".setpay", "09"},{".stm", "00"},{".shar", "09"},{".sh", "09"},{".sit", "09"},{".spl", "09"},{".sct", "00"},
            {".scd", "09"},{".sst", "09"},{".src", "09"},{".sv4cpio", "09"},{".tex", "09"},{".tgz", "08"},{".t", "09"},{".tar", "08"},
            {".tr", "09"},{".tif", "03"},{".txt", "00"},{".texinfo", "09"},{".trm", "09"},{".tiff", "03"},{".tcl", "09"},{".texi", "09"},
            {".tsv", "00"},{".ustar", "09"},{".uls", "00"},{".vcf", "00"},{".wps", "01"},{".wav", "05"},{".wrz", "11"},{".wri", "09"},
            {".wks", "09"},{".wmf", "09"},{".wcm", "09"},{".wrl", "11"},{".wdb", "09"},{".wsdl", "00"},{".xap", "09"},{".xml", "00"},
            {".xlm", "01"},{".xaf", "11"},{".xla", "01"},{".xls", "01"},{".xlsx", "01"},{".xof", "11"},{".xlt", "01"},{".xlc", "01"},
            {".xsl", "00"},{".xbm", "03"},{".xlw", "01"},{".xpm", "03"},{".xwd", "03"},{".xsd", "00"},{".z", "08"},{".zip", "08"}
        };
        ...
        public static string GetFileType(string fileName)
        {
            ...
            string ext = Path.GetExtension(fileName).ToLower();
            string result = string.Empty;
            if (!typeDict.TryGetValue(ext, out result))
            {
                result = "99";
            }
            return result;
